...
{
    public class AdTargetRepository : EntityRepositoryBase<AdTarget, ApplicationDbContext>, IAdTargetRepository
    {
        readonly ApplicationDbContext _context;
        public AdTargetRepository(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
