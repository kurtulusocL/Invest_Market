...
{
    public class CompanyContactRepository : EntityRepositoryBase<CompanyContact, ApplicationDbContext>, ICompanyContactRepository
    {
        readonly ApplicationDbContext _context;
        public CompanyContactRepository(ApplicationDbContext context) : base(context)
        {
            _context = context;
        }
